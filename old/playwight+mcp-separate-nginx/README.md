...
- `playwright-mcp` – basiert auf dem offiziellen `mcr.microsoft.com/playwright`-Image und enthält `@playwright/mcp`, `desktop-lite` (TigerVNC + noVNC + Fluxbox) sowie Chromium.
